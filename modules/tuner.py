"""
Tuner module for hyperparameter tuning.
"""
...
def model_builder(hp, vectorizer_layer):
    """
    Builds a feedforward neural network model with hyperparameters.

    Args:
        hp: Hyperparameters object that contains the search space.
        vectorizer_layer: Text vectorization layer.

    Returns:
        A compiled feedforward neural network model.
    """
